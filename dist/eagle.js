 ...
 */
var callbacks, counter, nextTickHandle, observer, textNode, timeFuction,
...
exports.isFunction = function(arg) {
  var type;
  type = {};
  return arg && type.toString.call(arg) === '[object Function]';
};
...
var Component, Delegator, Watcher, argsToArray, createElement, diff, extend, h, html, isFunction, observer, parser, patch, ref, ref1, replaceWith, uid;

parser = __webpack_require__(22);

h = __webpack_require__(43);

createElement = __webpack_require__(41);

diff = __webpack_require__(42);

patch = __webpack_require__(44);

Delegator = __webpack_require__(34);

ref = __webpack_require__(12), replaceWith = ref.replaceWith, html = ref.html;

observer = __webpack_require__(26);

Watcher = __webpack_require__(28);

ref1 = __webpack_require__(1), argsToArray = ref1.argsToArray, extend = ref1.extend, isFunction = ref1.isFunction;
...
module.exports = Component = (function() {
  ...
  function Component(options, context) {
    ...
    if (isFunction(this.options.template)) {
      this.options.template = this.options.template.call(this, this.el.innerHTML);
    }
...
parseText = __webpack_require__(25);

flatten = __webpack_require__(1).flatten;

parseEvent = __webpack_require__(23).parseEvent;
...
generator = {
   ...
   * is html attr
   */
  isHTMLAttrs: function(attr) {
    return attr.indexOf(':') !== 0 && attr.indexOf('e-') !== 0;
  },

  /*
   * is an attr is prop or not
   */
  isProps: function(attr) {
   ...
   * generator props
   */
  genProps: function(attrsMap, iterator, filter) {
    ...
    if (filter) {
      propsKeys = propsKeys.filter(function(v) {
        return filter.call(null, v);
      });
    }
    propsKeys.forEach(function(v) {
      return result.push(iterator.call(null, v, attrsMap[v]));
    });
    return result;
  },
  ...
  genCustomTag: function(el) {
    var e, htmlAttrs, props, query, sub;
    query = "[key=" + vm._id + "]";
    props = this.genProps(el.attrsMap, function(key, value) {
      return (key.slice(1)) + ": " + value;
    }, this.isProps);
    props = "props: { " + (props.join(',')) + " }";
    htmlAttrs = this.genProps(el.attrsMap, function(key, value) {
      return key + ": '" + value + "'";
    }, this.isHTMLAttrs);
    ...
    return "__h__( 'div', {attributes: {'key': '" + vm._id + "'}}, " + (this.children(el.children, el)) + ")";
  },
...
generator = __webpack_require__(21);
...
HTMLParser = __webpack_require__(19).HTMLParser;
...
ref = __webpack_require__(29), arrayMethods = ref.arrayMethods, arrayKeys = ref.arrayKeys;
...
var common, flushBatcherQueue, isInQueue, nextTick, queue, queueIds, resetBatcherState, runBatcherQueue, waiting;

common = __webpack_require__(30).common;
...
exports.pushWatcher = function(watcher) {
  var id;
  if (watcher == null) {
    watcher = {};
  }
  ...
  if (!isInQueue(id)) {
    ...
    if (!waiting) {
      waiting = true;
      return nextTick(flushBatcherQueue);
    }
  }
};
...
var Dependence, Watcher, pushWatcher, uid;

Dependence = __webpack_require__(11);

pushWatcher = __webpack_require__(27).pushWatcher;
...
/*
 * util index
 * @auhtor jackieLin <dashi_lin@163.com>
 */
var common, dom;
...
var EvStore = __webpack_require__(4)
var createStore = __webpack_require__(57)

var addEvent = __webpack_require__(32)
var removeEvent = __webpack_require__(36)
var ProxyEvent = __webpack_require__(35)
...
var hiddenStore = __webpack_require__(58);
